          ...
          <ListItem disableGutters key={match}>
            <ListItemButton >
              ...
              <Box sx={{display : "flex", minWidth : "300px", textAlign : "center"}}>
                {characterHistory[index][0] !== "" && <img style={{width : "50px", height : "50px"}} alt={""} src={`/Stock Icons/chara_2_${characterHistory[index][0]}.png`}/>}
                <ListItemText sx={{ml : "5px", mt : "15px"}} primary={`${match[0]} / ${match[1]}`} />
                {characterHistory[index][0] !== "" && <img style={{width : "50px", height : "50px"}} alt={""} src={`/Stock Icons/chara_2_${characterHistory[index][1]}.png`}/>}
              </Box>

                <Box sx={{display: "flex", justifyContent : "center"}}>
                    <ListItemText primaryTypographyProps={{fontSize: '24px', WebkitTextStrokeWidth : "1px", WebkitTextStrokeColor : color, fontWeight : "bold", mt : "4px"}}  primary={`${match[4] ? "-" : "+"} ${match[5]}`}/>
                ...
                <Box sx={{display : "flex", minWidth : "300px", textAlign : "center"}}>
                {characterHistory[index][0] !== "" && <img style={{width : "50px", height : "50px"}} alt={""} src={`/Stock Icons/chara_2_${characterHistory[index][2]}.png`}/>}
                <ListItemText sx={{ml : "5px", mt : "15px"}} primary={`${match[2]} / ${match[3]}`} />
                {characterHistory[index][0] !== "" && <img style={{width : "50px", height : "50px"}} alt={""} src={`/Stock Icons/chara_2_${characterHistory[index][3]}.png`}/>}
              </Box>
